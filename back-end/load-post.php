...
$sql2 = "Select * FROM post INNER JOIN users ON (users.unique_id = post.unique_id) and (post.post_role = 1) and (post.post_status = 1)  ORDER BY post_id DESC LIMIT {$start},{$quantity}";
